...
public class Rectangle extends Tool {
    ...
    public Rectangle(ChartConfig config, double price1, LocalDateTime dateTime1,
                     double price2, LocalDateTime dateTime2, ENUM_TIMEFRAME timeframe) {
    ...
    public void draw(Graphics2D g2d, AffineTransform transform, int width, int height) {
        ...
        if (isVisible) {
            frameRect.setRoundRect(rectX, rectY, rectWidth, rectHeight, radius, radius);
